...
[ApiController]
[Route("api/calculators/tax/estv")]
        ...
        FullTaxRequest request)
    {
        ...
        FullTaxResponse MapResponse(FullTaxResult r)
        {
            return new FullTaxResponse
            {
                ...
                IncomeTaxAmount = r.StateTaxResult.TotalIncomeTax + r.FederalTaxResult.TaxAmount,
                WealthTaxAmount = r.StateTaxResult.TotalWealthTax,
