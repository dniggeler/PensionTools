...
public class PensionVersusCapitalCalculatorTests : IClassFixture<ToolsFixture<IPensionVersusCapitalCalculator>>
{
    ...
    [Theory]
    [InlineData(50_000, 28680, 1_000_000, 261, 20.596)] // Zürich
    [InlineData(50_000, 28680, 1_000_000, 141, 20.51)] // Zürich
    [InlineData(50_000, 28680, 1_000_000, 3426, 23.65)] // SG
    [InlineData(50_000, 28680, 1_000_000, 2526, 24.245)] // SO
