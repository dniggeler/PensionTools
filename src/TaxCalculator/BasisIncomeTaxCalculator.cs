    ...
    public class BasisIncomeTaxCalculator : IBasisIncomeTaxCalculator
    {
        ...
        public Task<Either<BasisTaxResult, string>> CalculateAsync(int calculationYear, BasisTaxPerson person)
        {
            ...
            return Map(person.CivilStatus)
                ...
                // calculate result
                .Map(tariff => CalculateIncomeTax(calculationYear, person, tariff))
        ...
        private BasisTaxResult CalculateIncomeTax(int calculationYear, BasisTaxPerson person, TaxTariffModel tariff)
        {
            {
